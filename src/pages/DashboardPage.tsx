    ...
    <div className="min-h-screen bg-background text-foreground p-6">
      <div className="max-w-6xl mx-auto space-y-10 text-center">
        ...
        <div className="flex justify-center mb-6">
          <div className="flex items-center bg-gray-300 rounded-2xl px-4 py-3 w-full max-w-md">
            ...
            <input
              ...
              className="flex-1 bg-transparent outline-none text-gray-500 placeholder-gray-400 text-sm"
            />
        ...
        <h1 className="text-5xl font-bold tracking-tighter">
          AI Social <span className="text-primary">Project</span>
        </h1>
